...
class AndroidConfigChecker:
    def __init__(self) -> None:
        self._google_service_json_path = "./TMessagesProj_App/google-services.json"

        self._android_manifest_xml_path = "./TMessagesProj/src/main/AndroidManifest.xml"
        self._project_gradle_path = "./build.gradle"
        self._app_gradle_path = "./TMessagesProj_App/build.gradle"
